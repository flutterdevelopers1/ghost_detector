...
import 'package:ghost_detector/app/audio/recorder/interceptor_node.dart';
  ...
  void connectVolumeToConverter(
    ...
    builder
      ...
      ..connect(
          ...
          inputNodeId: _delayNodeId,
          inputBusIndex: 0)
      ..connect(
          outputNodeId: _delayNodeId,
          outputBusIndex: 0,
          inputNodeId: _interceptorNodeId,
          inputBusIndex: 0)
      ..connect(
          outputNodeId: _interceptorNodeId,
          outputBusIndex: 0,
