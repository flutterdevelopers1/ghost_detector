...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text("GHOST DETECTOR",style: TextStyle(color: Colors.white70,fontWeight: FontWeight.w900),),
          backgroundColor: Colors.black,
        ),
        drawer: Drawer(
          backgroundColor: Colors.black,
          child: ListView(
            children: [
              Center(
                child: DrawerHeader(
                 child: Center(child: Text("Welcome To  Ghost Detector",style: TextStyle(color: Colors.white38,fontSize: 23,fontWeight: FontWeight.w900),)),
              ...
              ListTile(
                leading: Icon(Icons.mobile_screen_share_outlined,color: Colors.white70),
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      child: Text("EMF",style: TextStyle(color: Colors.black),)),
                ),
